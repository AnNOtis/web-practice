...
//          buyPrice = this.getString(this.Now, self.marketPlace);
 ...
 var hAndW0=_amzn_utils.getTextHeightAndWidth(buyButtonStr, "100% Verdana, Arial, Helvetica, sans-serif","10", true, "", self);
    ...
    recordImpression: function(tag, linkCode,  marketPlace) {
        ...
        img.src = prefix + '://' + this.getString(this.AssocImpVIP, marketPlace) + '/e/ir?'
                + 'o=' + orgUnit
                + '&t=' + tag
                + '&l=' + linkCode;
        ...
        if(marketPlace == 'US') {
            // call SIS tracker
            try {
                var encodedRefUrl = (function(b){ return b && encodeURIComponent(b).replace(/&/g, "&amp;").replace(/\"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;") })( document.location );
                var sisPixelUrl = prefix + "://s.amazon-adsystem.com/iui3?d=assoc-amazon.com&enId=Associates&eId=view&r=1&rP=" + encodedRefUrl + "&cB=" + Math.random() * 1E16 ;
                (new Image()).src = sisPixelUrl ;
            } catch (e) {} //ignore
    ...
    recordPopover: function(tag, linkCode,  marketPlace, asin) {
        ...
        img.src = prefix + '://' + this.getString(this.AssocImpVIP, marketPlace) + '/s/pp?'
                + 'o=' + orgUnit
                + '&t=' + tag
                + '&l=' + linkCode
                + '&asin=' + asin;
    ...
    widgetServerURL: function(marketPlace) {
        var wsURL = this.getString(this.WSUrl, marketPlace);
        if (typeof isAmznWC != 'undefined' && (isAmznWC == 1 || isAmznWC == '1')) {
    ...
    amznMediaserverURL: function(marketPlace) {
        var wmsURL = this.getString(this.WMSUrl, marketPlace);
        if (typeof isAmznWC != 'undefined' && (isAmznWC == 1 || isAmznWC == '1')) {
